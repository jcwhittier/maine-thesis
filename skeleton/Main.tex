...
% configuration for list of queries
\renewcommand\lstlistingname{Query}
\renewcommand\lstlistlistingname{LIST OF QUERIES}
\def\lstlistingautorefname{Query}

\makeatletter
\renewcommand{\l@lstlisting}[2]{%
  \@dottedtocline{1}{0em}{2.8em}{\lstlistingname\ #1}{#2}%
}
\makeatother
